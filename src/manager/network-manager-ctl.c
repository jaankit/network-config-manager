...
_public_ int ncm_generate_networkd_config_from_yaml(int argc, char *argv[]) {
...
_public_ int ncm_generate_networkd_config_from_command_line(int argc, char *argv[]) {
...
_public_ int ncm_cli_run(int argc, char *argv[]) {
        ...
        static const Cli commands[] = {
                ...
                { "generate-config-from-yaml",    1,        WORD_ANY, false, ncm_generate_networkd_config_from_yaml },
                { "apply-yaml-config"           , WORD_ANY, WORD_ANY, false, ncm_generate_networkd_config_from_yaml },
                { "generate-config-from-cmdline", WORD_ANY, WORD_ANY, false, ncm_generate_networkd_config_from_command_line },
                {}
        };
